...
caminho_arquivo_mais_recente = arquivo_mais_recente.path # Caminho completo do arquivo mais recente
...
colunasint = ['NUMERO_NF', 'VALOR_PARCELA_RECEBIDA','NUM_PARCELA']
...
# DBTITLE 1,Insert no dataframe
#tabela completa sem os dados novos
